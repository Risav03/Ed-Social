...
export const AreaInput = ({content, setContent, heading, placeholder, required}:{type?: string, required:boolean, content:string, setContent:Dispatch<string>, heading:string, placeholder:string, area?:boolean}) => {
  return (
